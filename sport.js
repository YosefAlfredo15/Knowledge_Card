(function(){
    ...
    function showResults(){
      ...
      myQuestions.forEach( (currentQuestion, questionNumber) => {
        ...
        if(userAnswer === currentQuestion.correctAnswer){
          ...
          resultsContainer.innerHTML = "Sealamat Jawaban Anda Benar! (silahkan kembali ke menu awal)"
    ...
    const myQuestions = [
      {
        question: "Sebutkan Teknik dasar bermain sepak bola",
        answers: {
          a: "menendang memukul, dan menjambak",
          b: "mengumpan, menangkis, dan melukis", 
          c: "menembak, berlari, dan bergaya",
          d: "Mengumpan, dribbling, menembak, dan menyundul",
        },
        correctAnswer: "d"
      },
